...
async function seedQuestions() {
  ...
  await Questions.insertMany([
    ...
    {
      question:
        "What famous work of Niccolo Machiavelli redefined the beliefs of cynicism in the Italian Renaissance?",
      answer: "The Prince",
      category: "Art and Literature",
      _id: 18,
    },
    {
      question:
        "The film Clueless is a modern take on which literary classic by Jane Austin?",
      answer: "Emma",
      category: "Art and Literature",
      _id: 19,
    },
    ...
    {
      question:
        "What did Hugh Heffner originally plan to call his Playboy magazine?",
      answer: "Stag Party",
      category: "Art and Literature",
      _id: 21,
    },
    ...
    {
      question:
        "When viewed at a certain angle, the 1553 painting: `The Ambassadors` reveals which mysterious object?",
      answer: "A skull",
      category: "Art and Literature",
      _id: 27,
    },
    ...
    {
      question:
        "What was the name of the first full novel written by Charles Dickens?",
    ...
    {
      question:
        "Which Arthur Miller play featured the character Willy Loman, and was made into a 1951 film starring Frederick March?",
    ...
    {
      question:
        "In which Shakespeare play would you find the character Ophelia?",
      answer: "Hamlet",
      category: "Art and Literature",
      _id: 41,
    },
    ...
    {
      question:
        "Who played Mr Darcy in the 1995 BBC adaptation of the Pride and Prejudice?",
      answer: "Colin Firth",
      category: "Art and Literature",
      _id: 43,
    },
    ...
    {
      question:
        "What is the last book in the Chronicles of Narnia by C.S. Lewis?",
    ...
    {
      question:
        "In Charles Dickens `A Tale of Two Cities`, what were the two cities?",
    ...
    {
      question:
        "According to Bram Stoker`s original novel, by which seaside town did Count Dracula enter England?",
      answer: "Whitby",
      category: "Art and Literature",
      _id: 53,
    },
    ...
    {
      question:
        "Created in the 1930s and the subject of a 1975 film, which pulp hero was Lester Dent best known for creating?",
      answer: "Doc Savage",
      category: "Art and Literature",
      _id: 57,
    },
    {
      question:
        "Which author created the character Harry Palmer, who was played on film by Michael Caine?",
      answer: "Len Deighton",
      category: "Art and Literature",
      _id: 58,
    },
    ...
    {
      question:
        "What was the name of the marooned mariner on `Treasure Island`?",
      answer: "Ben Gunn",
      category: "Art and Literature",
      _id: 61,
    },
    ...
    {
      question:
        "Which famous writer, who used the line `God for Harry, England and St. George!` in one of his works, was said to have been born and died on St George`s Day?",
    ...
    {
      question:
        "How much did the Owl and the Pussy Cat pay for their wedding ring?",
      answer: "One shilling",
      category: "Art and Literature",
      _id: 73,
    },
    ...
    {
      question:
        "Which character from a famous poem brought a curse on his crew after killing an albatross?",
    ...
    {
      question:
        "In Literature, how is the character of Oliver Mellors better known?",
    ...
    {
      question:
        "What was the first name of the fictional detective Miss Marple?",
      answer: "Jane",
      category: "Art and Literature",
      _id: 89,
    },
    {
      question:
        "In which Dickens novel would you find a convict called Magwitch?",
    ...
    {
      question:
        "The author of `Dracula`, Bram Stoker`s first name is short for what?",
      answer: "Abraham",
      category: "Art and Literature",
      _id: 91,
    },
    ...
    {
      question:
        "The works of Mrs Darrell Waters have been translated into 128 languages, but by which name is she better known?",
      answer: "Enid Blyton",
      category: "Art and Literature",
      _id: 97,
    },
    ...
    {
      question:
        "Which is the only USA state that has no letters in common with its state capital?",
    ...
    {
      question:
        "What is the purpose of the black stripe on a school crossing warden`s `lollipop`?",
    ...
    {
      question:
        "Which letter of the alphabet appears only once in the names of all English and Scottish league football teams and not at all in the names of the elements in the Periodic Table?",
    ...
    {
      question:
        "If you walked one mile south, one mile west, and then one mile north, and ended up where you started, where would you be?",
    ...
    {
      question:
        "The Savoy Grill, the Boxwood CafÃƒÂ© at the Berkeley Hotel and Maze are all restaurants owned by which famous chef?",
    ...
    {
      question:
        "What sport was at the centre of Death In The Afternoon by Ernest Hemmingway?",
    ...
    {
      question:
        "Which famous marionette accompanied Annette Mills on her piano?",
    ...
    {
      question:
        "Which make of car is named after it`s intended market - the U.S.A ?",
    ...
    {
      question:
        "Also the name of an English city, Harare, the capital of Zimbabwe was known as what until 1987?",
      answer: "Salisbury",
      category: "Geography",
      _id: 232,
    },
    {
      question:
        "Which two countries are double-landlocked (i.e. surrounded only by other landlocked countries)?",
    ...
    {
      question:
        "The world`s smallest independant country since 1929 has a birth rate of zero. What is it called?",
    ...
    {
      question:
        "In which North Amercan city is there a neighbourhood known as Hell`s Kitchen?",
      answer: "New York",
      category: "Geography",
      _id: 243,
    },
    ...
    {
      question:
        "On which group of Scottish islands would you find the neolithic village of Skara Brae?",
      answer: "The Orkneys",
      category: "Geography",
      _id: 245,
    },
    ...
    {
      question:
        "Still in use today, which country`s flag is the oldest in the world?",
      answer: "Denmark`s",
      category: "Geography",
      _id: 247,
    },
    {
      question:
        "To which country does the territory of Christmas Island belong?",
      answer: "Australia",
      category: "Geography",
      _id: 248,
    },
    ...
    {
      question:
        "In which Australian state of territory will you find the Adelaide river?",
    ...
    {
      question:
        "What connects the end of the M4 and the end of the Suez Canal?",
    ...
    {
      question:
        "Which country was previously called the Republic of Upper Volta?",
      answer: "Burkina Faso",
      category: "Geography",
      _id: 267,
    },
    ...
    {
      question:
        "What is the name of the plain that was once the chief industrial region of the USSR?",
    ...
    {
      question:
        "What number is Britain in a list of the largest islands in the world? 4th, 8th or 15th?",
      answer: "8th",
      category: "Geography",
      _id: 283,
    },
    ...
    {
      question:
        'At the intersection of which four American states would you find the "Four Corners"?',
    ...
    {
      question:
        "What is the southern hemisphere equivalent of the Aurora Borealis, also known as the Northern Lights?",
    ...
    {
      question:
        "Located in Russia near the border with Georgia, what is the highest mountain in Europe?",
      answer: "Mount Elbrus",
      category: "Geography",
      _id: 297,
    },
    ...
    {
      question:
        "Which famous comedian made a record called `please mister custer` in 1960?",
    ...
    {
      question:
        "In 1976, which single was knocked from the number one spot by a single whose title was contained in the lyrics to the first single?",
      answer:
        "Bohemian Rhapsody by Queen (being replaced by Mamma Mia by Abba)",
      category: "Music",
      _id: 371,
    },
    {
    ...
    {
      question:
        "Which heavy metal band had a UK number hit in January 1991 and what was the name of the song?",
    ...
    {
      question:
        "What do the songs `Killer` by Adamski, `Paranoid Android` by Radiohead and `True Faith` by New Order have in common?",
    ...
    },
    {
      ...
      answer:
        "CQD - CQ was a general call to all ships and D signalled Distress",
      category: "History",
      _id: 410,
    },
    {
    ...
    {
      question:
        "Which comedian was the first person in Britain to make a call on a mobile phone?",
    ...
    {
      question:
        "To which country did Tanzania belong before becoming a British mandate?",
      answer: "Germany",
      category: "History",
      _id: 423,
    },
    ...
    {
      question:
        "Between them, the six wives of HenryVIII were of three different nationalities. English, Spanish and what other?",
    ...
    {
      question:
        "The doomed ship Titanic had two sister ships. What were their names?",
    ...
    {
      question:
        "Was the West German currency introduced in East Germany before or after re-unification in 1990?",
      answer: "Before",
      category: "History",
      _id: 434,
    },
    ...
    {
      question:
        "How old was Prince Charles when he was invested as Prince of Wales?",
    ...
    {
      question:
        "Who appeared on a World War I recruitment poster above the words `Your country needs YOU`?",
    ...
    {
      question:
        "With what did the CIA reputedly try to assassinate Fidel Castro?",
    ...
    {
      question:
        "Which famous Greek was a student of Plato and teacher to Alexander the Great?",
      answer: "Aristotle",
      category: "History",
      _id: 456,
    },
    {
      question:
        "In Egyptian mythology, who was the God of embalming who also watched over the dead?",
      answer: "Anubis",
      category: "History",
      _id: 457,
    },
    ...
    {
      question:
        "In Norse mythology, what name was given to the female warriors who carried the bodies of heroes from the battlefield to feast in Valhalla?",
      answer: "Valkyrie",
      category: "History",
      _id: 460,
    },
    ...
    {
      question:
        "In which decade did America last have four presidents? 1850s, 1880s or 1910s?",
      answer: "1880s",
      category: "History",
      _id: 464,
    },
    ...
    {
      question:
        "What was the name of the Duke of Wellingtons horse at the Battle of Waterloo?",
      answer: "Copenhagen",
      category: "History",
      _id: 467,
    },
    ...
    {
      question:
        "Other than Scapa Flow, where was much of the British fleet protected during World War 2?",
      answer: "Loch Ewe",
      category: "History",
      _id: 470,
    },
    ...
    {
      question:
        "Before becoming President of the United States, George W Bush was govenor of which state?",
      answer: "Texas",
      category: "History",
      _id: 473,
    },
    {
      question:
        "Who was the oldest to be elected president of the United States?",
      answer: "Ronald Reagan",
      category: "History",
      _id: 474,
    },
    ...
    {
      question:
        "Who was president of the United States during the brief Spanish-American war?",
    ...
    {
      question:
        "What yellow fossilised resin was used as jewellery by the Greeks and Romans?",
      answer: "Amber",
      category: "History",
      _id: 477,
    },
    ...
    {
      question:
        "Which achievement links Arthur Martin-Leake, Noel Chavasse and Charles Upham?",
    ...
    {
      question:
        "Colonel James Doolittle led the first bombing raid on which city during World War II?",
      answer: "Tokyo",
      category: "History",
      _id: 482,
    },
    {
      question:
        "Born in 1599, who coined the phrase `warts and all` while sitting for a portrait?",
    ...
    {
      question:
        "When Eugene Cernan and Harrison Schmitt were the last people to walk on the moon, what number was their Apollo mission?",
      answer: "XVII (17)",
      category: "History",
      _id: 484,
    },
    {
      question:
        "Which World War II action had the code name Operation Chastise?",
    ...
    {
      question:
        "Before Tony Blair, who was the previous leader of the Labour Party to win a general election?",
    ...
    {
      question:
        "Which famous leader once said `I`m still at the crease, but the bowling is more hostile these days`?",
    ...
    {
      question:
        "What is the significance of the dates August 9th 1902, June 23rd 1911, May 12th 1937 and June 2nd 1953?",
    ...
    {
      question:
        "Mount Wilson in California, siding Spring in Australia and Mauna Kea in Hawaii. What`s the scientific connection?",
    ...
    {
      question:
        "What is the name given to the green alkaline fluid produced by the liver?",
      answer: "Bile",
      category: "Science and Nature",
      _id: 583,
    },
    ...
    {
      question:
        "What is the art of clipping hedges into various shapes called?",
      answer: "Topiary",
      category: "Science and Nature",
      _id: 590,
    },
    ...
    {
      question:
        "Name the athletes who carried Great Britain`s flag into the Beijing Olympic Stadium at the start and end of the 2008 Summer Olympics.",
    ...
    {
      question:
        "What was the nickname given to the famous boxing match between Mohammad Ali and Joe Frazier in1975?",
    ...
    {
      question:
        "Which football team are known as the Rosso-nera or Rosso-Neri?",
      answer: "AC Milan",
      category: "Sport",
      _id: 634,
    },
    ...
    {
      question:
        "Which is the only horse to have won English, Scotish and Welsh Grand Nationals?",
      answer: "Earth Summit",
      category: "Sport",
      _id: 636,
    },
    ...
    {
      question:
        "Which animal is South African rugby union player Bryan Habana often compared to?",
      answer: "Cheetah",
      category: "Sport",
      _id: 641,
    },
    ...
    },
    {
      ...
      answer:
        "Philadelphia Eagles, Baltimore Ravens, Seattle Seahawks, Arizona Cardinals and Atlanta Falcons",
      category: "Sport",
      _id: 648,
    },
    {
      question:
        "Which South American country will host the 2014 FIFA World Cup?",
      answer: "Brazil",
      category: "Sport",
      _id: 649,
    },
    {
      question:
        "Name four race courses in the UK that don`t have any of letters from the word `race` in their name?",
    ...
    {
      question:
        "With which sport do you associate the English seed merchant Samuel Ryder?",
    ...
    {
      question:
        "How many times has the host nation won the football World Cup?",
      answer:
    ...
    {
      question:
        "What is the diameter of a basketball hoop? 12 inches, 18 inches or 24 inches?",
      answer: "18 inches",
      category: "Sport",
      _id: 657,
    },
    ...
    {
      question:
        "Wembley finally hosted an FA Cup fin 2007, but which two teams were the last to compete in the FA Cup final at the old Wembley?",
    ...
    {
      question:
        "In which country are the first-class cricket sides United Bank and National Bank based?",
      answer: "Pakistan",
      category: "Sport",
      _id: 664,
    },
    {
      question:
        "The Nursery End, the Pavilion End and St John`s Road are all linked with which sporting ground?",
      answer: "Lords",
      category: "Sport",
      _id: 665,
    },
    {
      question:
        "Which is the only racecourse in Yorkshire not to host flat racing?",
      answer: "Wetherby",
      category: "Sport",
      _id: 666,
    },
    {
      question:
        "In which sport may a match be decide using the Duckworth Lewis method?",
    ...
    {
      question:
        "Which football team has its ground closest to the river Mersey?",
    ...
    {
      question:
        "As at 2006, how many times have Liverpool FC won the European Cup / Champions League?",
      answer: "5",
      category: "Sport",
      _id: 677,
    },
    ...
    {
      question:
        "What football club did Sir Matt Busby sign for at the age of 17?",
    ...
    {
      question:
        "In which sport might you see the two teams defending goals of different sizes?",
    ...
    {
      question:
        "Name the footballer at club level who has played along side Bobby Moore, Liam Brady and Alan Shearer?",
      answer: "Tony Gale",
      category: "Sport",
      _id: 681,
    },
    ...
    {
      question:
        "Which Marquis of Queensbury formulated the rules of boxing? The 1st, 4th or 8th?",
      answer: "8th",
      category: "Sport",
      _id: 683,
    },
    ...
    {
      question:
        "As at 2006, who was the last european to win the Tour de France?",
    ...
    {
      question:
        "At the end of the 2005/06 Premiership season, which football team had the stadium with the highest capacity?",
    ...
    {
      question:
        "Which player scored England`s first goal in the 2006 World Cup?",
    ...
    {
      question:
        "Who is the oldest man to score in the final stages of a World Cup and for which country?",
      answer:
        "Roger Milla of Cameroon (He was 42 when he scored against Russia in 1994)",
      category: "Sport",
      _id: 690,
    },
    {
      question:
        "Who were the last team to be runners-up in 2 consecutive World Cups?",
    ...
    {
      question:
        "Which 2 teams contested the only World Cup final to end 0-0 before penalties?",
    ...
    {
      question:
        "Which is the only non European country to host the World Cup more than once?",
    ...
    {
      question:
        "Who became World Professional Snooker Champion for the first time in 2006?",
      answer: "Graeme Dott",
      category: "Sport",
      _id: 695,
    },
    {
      question:
        "Between which two football teams was the first ever penalty shoot out to decide a competitive match?",
    ...
    {
      question:
        "Which England footballer of the 1970s had the nickname Crazy Horse?",
      answer: "Emlyn Hughes",
      category: "Sport",
      _id: 697,
    },
    ...
    {
      question:
        "Who is the only character to appear in the first ever Coronation Street who is still in the show as at 2009?",
      answer: "Ken Barlow",
      category: "Film and TV",
      _id: 704,
    },
    ...
    },
    {
      ...
      answer:
        "Somalia - (two helicopters were shot down by rocket propelled grenades)",
      category: "Film and TV",
      _id: 706,
    },
    {
    ...
    {
      question:
        "As at 2009, what is the last Best Picture Oscar winning film to also win Best Actor and Best Actress Oscars?",
    ...
    {
      question:
        "In TV show Button Moon, what was the name of Mr Spoon`s daughter?",
    ...
    {
      question:
        "Which actor, who died on April 5th 2008, was originally considered for the role of Chief Brody in the 1975 film Jaws?",
    ...
    {
      question:
        "What is the first name of the character Lewis in the TV series of the same name?",
      answer: "Robert",
      category: "Film and TV",
      _id: 729,
    },
    {
      question:
        "Name all of the seven dwarves in Disney`s Snow White And The Seven Dwarfs?",
    ...
    {
      question:
        "What were the first names of Riggs and Murtaugh in the Lethal Weapon films?",
    ...
    {
      question:
        "Which Carry On star died on the stage of the Sunderland Empire in 1976?",
      answer: "sid James",
      category: "Film and TV",
      _id: 737,
    },
    ...
    {
      question:
        "Who were the two voice artists of the cartoon characters Dangermouse and his sidekick Penfold?",
    ...
    {
      question:
        "In the TV show The Simpsons, how is the character of Robert Terwilliger normally known?",
      answer: "sideshow Bob",
      category: "Film and TV",
      _id: 746,
    },
    ...
    {
      question:
        "What is the name of the character played by Robert de Niro in the 1976 film Taxi Driver?",
    ...
    {
      question:
        "In 2007, which film topped the list of the American Film Institute`s top 100 films of all time?",
      answer: "Citizen Kane",
      category: "Film and TV",
      _id: 755,
    },
    ...
    {
      question:
        "Which famous actor was born in 1916 with the real name of Issur Danielovitch Demsky?",
      answer: "Kirk Douglas",
      category: "Film and TV",
      _id: 757,
    },
    {
      question:
        "Which actress, model and singer served 18 days in prison for tax evaxion in 1982?",
      answer: "Sofia Loren",
      category: "Film and TV",
      _id: 758,
    },
    ...
    {
      question:
        "What was the name of the car in the TV series The Dukes of Hazard?",
    ...
    {
      question:
        "What was the title of Orson Welles' last movie, in which he voiced a character called Unicron?",
    ...
    {
      question:
        "Which 2005 Nobel prize-winning English playwright wrote the screenplay for the film The French Lieutenant`s Woman?",
    ...
    {
      question:
        "Who starred in the title role of the film version of J B Priestley`s play An Inspector Calls?",
      answer: "Alastair Sim",
      category: "Film and TV",
      _id: 775,
    },
    ...
    {
      question:
        "In the film `Cannonball Run` what was the name of the super-hero played by Dom DeLuise?",
    ...
    {
      question:
        "Who plays Billy Costigan in the 2006 Oscar winning film The Departed?",
    ...
    {
      question:
        "Which Oscar winning actress played Stella Bridger in the 2003 remake of the Italian Job?",
    ...
    {
      question:
        "Charles Fleischer voiced the title character in which 1988 film?",
    ...
    {
      question:
        "Which Oscar winning screenplay writer also co-wrote the screenplay for the movie Superman 2?",
      answer: "Mario Puzo",
      category: "Film and TV",
      _id: 785,
    },
    {
      question:
        "Which cast member of The Magnificent Seven had a scene from the film enacted at his wedding during filming?",
      answer: "Yul Brynner",
      category: "Film and TV",
      _id: 786,
    },
    ...
    {
      question:
        "Which 1959 Alfred Hitchcock film had the tagline `Its a deadly game of tag and Cary Grant is it!`?",
    ...
    {
      question:
        "The theme tune for `TFI Friday` was taken from which 1960s TV series?",
    ...
    {
      question:
        "I n the film `The Great Escape` what were the code names of the 3 tunnels?",
    ...
    {
      question:
        "Which film character`s car had the registration number BMT214A?",
    ...
    {
      question:
        "What was the name of the baby of Wayne and Waynetta Slob in the Harry Enfield Show?",
      answer: "Frogmella",
      category: "Film and TV",
      _id: 796,
    },
